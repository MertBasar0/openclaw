...
def main() -> int:
    ...
    parser.add_argument("kind", choices=["capability-probe", "dotnet-info", "outlook-job-signal-scan", "graph-auth-status", "graph-auth-login", "graph-mail-job-signal-scan", "sketchup-poc-action", "blender-bonsai-action"])
