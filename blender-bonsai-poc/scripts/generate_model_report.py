...
def build_next_actions(
    ...
    if geometry_level == "real-ifc-shape-representations":
        ...
        if action != "ifc-multiroom-demo":
            ...
            actions.append(
                "Add an external viewer validation pass for the multi-room sample before broadening the copilot surface."
            )
        return actions
    actions = [
    ...
    if action != "ifc-multiroom-demo":
        actions.append("Expand the sample set beyond the single-room layout to cover multi-room or multi-storey cases before broadening the copilot surface.")
    else:
        actions.append("Add an external viewer validation pass for the multi-room sample before broadening the copilot surface.")
    return actions
...
def build_report(
    ...
    return {
        ...
        "recommendedNextActions": build_next_actions(geometry_level, hosting_readiness, geometry_readiness, action),
