...
const enLabs = {
  labsPage: {
    decisionAssistance: {
      ...
      description:
        "Let the built-in OpenClaw runtime omit optional tools on self-contained conversational turns. Requires a Decision model, set globally or per agent. Other harnesses keep their normal tools.",
