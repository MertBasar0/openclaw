...
- **Watch Payload Formatter:** Crucial component. Takes raw ACP outputs and prompts Gemini: *"Summarize this result in 1 sentence suitable for a smartwatch audio response. If it contains code or complex data, flag 'requires_phone_handoff: true'."*
